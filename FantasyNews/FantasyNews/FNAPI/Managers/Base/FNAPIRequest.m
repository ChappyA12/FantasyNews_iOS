...
+ (FNAPIRequest *)method:(NSString *)method
                    base:(NSString *)base
                    path:(NSString *)path {
    return [FNAPIRequest method:method base:base path:path params:nil body:nil];
}
...
+ (FNAPIRequest *)method:(NSString *)method
    ...
    return [FNAPIRequest method:method base:base path:path params:nil body:body];
}
...
+ (FNAPIRequest *)method:(NSString *)method
    ...
    return [FNAPIRequest method:method base:base path:path params:params body:nil];
}
